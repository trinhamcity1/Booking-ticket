    ...
    return (
        ...
        <div>
            ...
            <form action="">
                ...
                <div className ="form-group">
                    <label htmlFor="arrival_airport0">Arrival airport</label>
                ...
                <div className ="form-group">
                    <label htmlFor="seats_available">Number of tickets you want to buy.</label>
